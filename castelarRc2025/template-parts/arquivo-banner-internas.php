        ...
        <?php if (have_posts()) : ?>
            <?php while (have_posts()) : the_post(); ?>
                ...
                <div class="slide-items desktop-banner"
                    style="background: url(<?php echo wp_kses_post($imagem_banner); ?>), var(--corPrincipal); 
                            background-size: cover;">
                    <div class="gridTextosBanner desktop-banner">
                        <!-- Exibe o título da página atual -->
                        <h1 class="tituloPrincipal text-center text-white"><?php echo esc_html($page_title); ?></h1>
                    </div>
                </div>

                <!-- Imagem para telas menores que 992px -->
                <div class="slide-items mobile-banner"
                    style="background: url(<?php echo wp_kses_post($imagem_banner_mobile ? $imagem_banner_mobile : $imagem_banner); ?>), var(--corPrincipal); 
                            background-size: cover;">
