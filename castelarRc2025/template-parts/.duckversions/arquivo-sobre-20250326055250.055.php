        ...
        <div class="container">
          <div class="row d-flex justify-content-center align-items-flex-start gap-3">
            ...
            <div class="text-xl-start text-lg-center corTextos col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12">
              <p class="text-xl-end text-lg-center corTextos"><?php echo wp_kses_post(get_field('texto_chamada_sessao_sobre')); ?></p>
              <h2 class="tituloPrincipal justify-content-xl-start justify-content-lg-center text-xl-start text-lg-center">
