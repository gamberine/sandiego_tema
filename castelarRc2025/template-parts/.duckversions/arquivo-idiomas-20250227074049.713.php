...
<div class="gridIdiomas col-3">
  ...
  <span class="linkIdiomas d-flex"><?php echo do_shortcode('[gt-link lang="en" label="English" widget_look="flags_name"]'); ?></span>
  <span class="linkIdiomasPt"><?php echo do_shortcode('[gt-link lang="pt" label="Português" widget_look="flags_name"]'); ?></span>
  <span class="linkIdiomasCat"><?php echo do_shortcode('[gt-link lang="ca" label="Catalian" widget_look="flags_name"]'); ?></span>
