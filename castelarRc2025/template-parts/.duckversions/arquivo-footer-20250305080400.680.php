      ...
      <?php if (have_posts()) : ?>
        ...
        ?>
          ...
          <div class="col-xl-4 col-lg-4 col-md-12">
            ...
            <a class="" target="_blank" href="<?php echo esc_url(get_field('link_endereco_1')); ?>">
        ...
        <?php wp_reset_query(); ?>
          ...
          <div class="col-xl-3 col-lg-3 col-md-12 d-none d-md-none d-sm-none d-lg-block d-xl-block d-xxl-block">
