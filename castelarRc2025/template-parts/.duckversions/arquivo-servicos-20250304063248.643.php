  ...
  <div class="container">
    <div class="row">
      <div class="sliderImgTexto col-12" id="pisos">
        ...
        ?>
            <div class="text-center boxServicos col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12" id="<?php echo esc_attr(get_the_ID()); ?>">
              <div class="slide-item gridImgItems">
                <a href="javascript:void(0);" class="open-modal-img" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Clique para detalhes">
                  <img src="<?php echo esc_url(get_field('imagem_servico')); ?>" data-img-url="<?php echo esc_url(get_field('imagem_servico')); ?>" alt="<?php the_title(); ?>" />
                </a>
              </div>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <!-- Conteúdo opcional para o footer -->
                  </div>
                </div>
              </div>
            </div>
