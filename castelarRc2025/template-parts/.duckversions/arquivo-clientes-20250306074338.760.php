...
<section class="gridCinza" id="clientes">
  <div class="container text-center">
    <div class="row d-flex justify-content-center align-items-center text-center mb-3">
      ...
      Clique aqui e acompanhe a <a target="_blank" href="https://www.instagram.com/castelarrc"><span class="corPrincipalHover" style="font-size: larger; font-style: italic;">@castelar<strong>rc</strong></span></a> no Instagram
