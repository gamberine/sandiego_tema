  ...
  <?php if (have_posts()) : ?>
    <?php while (have_posts()) : the_post(); ?>
      ...
      <div class="w-100 d-flex flex-wrap flex-row mx-auto">
        <div class="boxImgContatos col-xxl-4 col-xl-4 col-lg-12 col-md-12" style="background: url(<?php echo wp_kses_post(get_field('background_contatos_esq')); ?>), var(--corSecundariaHover); background-size: cover !important;">
        ...
        <div class="boxImgContatos col-xxl-4 col-xl-4 col-lg-12 col-md-12" style="background: url(<?php echo wp_kses_post(get_field('background_contatos_dir')); ?>), var(--corSecundariaHover); background-size: cover !important;">
