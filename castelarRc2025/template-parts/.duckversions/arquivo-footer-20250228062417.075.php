...
<footer class="site-footer" id="contatos">
  ...
  <a class="btnWhatsAppFooter" target="_blank" href="<?php echo esc_url(get_field('linkWhatsapp_en')); ?>">
    <i class="fab fa-whatsapp"></i>
  </a>
  <a class="btnWhatsAppFooter" target="_blank" href="<?php echo esc_url(get_field('linkWhatsapp_ca')); ?>">
    <i class="fab fa-whatsapp"></i>
  </a>
