        ...
        <?php if (have_posts()) : ?>
            <?php while (have_posts()) : the_post(); ?>
                ...
                <div class="row text-center mb-0">
                    <h2 class="tituloPrincipal"><?php echo wp_kses_post(get_field('titulo_sessao_institucional')); ?></h2>
                </div>

                <div class="row mb-5 pb-5">
                    <!-- gamberine - remover formatação vinda do ACF -->
                    <h4 class="corSecundaria text-center mt-0 mb-4"><?php echo wp_kses_post(strip_tags(get_field('endereco'))); ?></h4>
