      ...
      <?php if (have_posts()) : ?>
        ...
        ?>
          ...
          <div class="col-xl-4 col-lg-4 col-md-12">
            ...
            <a class="" target="_blank" href="<?php echo wp_kses_post(get_field('linkTelefone')); ?>" translate="no">
              <i class="fa-solid fa-headset"></i>
              <?php echo wp_kses_post(get_field('numeroTelefone')); ?>
            </a>
            <a class="" target="_blank" href="<?php echo wp_kses_post(get_field('linkWhatsapp_pt')); ?>" translate="no">
            ...
            <a class="" target="_blank" href="<?php echo wp_kses_post(get_field('linkWhatsapp_ca')); ?>" translate="no">
              <i class="fab fa-whatsapp"></i>
              <?php echo wp_kses_post(get_field('numero_whatsapp_ca')); ?>
            </a>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-12 linksNoFooter">
            <a class="" target="_blank" href="mailto:<?php echo wp_kses_post(get_field('e-mail')); ?>" translate="no">
              <i class="far fa-envelope"></i>
              <?php echo wp_kses_post(get_field('e-mail')); ?>
            </a>
            <a class="" target="_blank" href="https://www.instagram.com/<?php echo wp_kses_post(get_field('conta_instagram')); ?>" translate="no">
              <i class="fab fa-instagram"></i>
              <?php echo wp_kses_post(get_field('conta_instagram')); ?>
            </a>
            <a class="" target="_blank" href="<?php echo esc_url(get_field('link_endereco_1')); ?>" translate="no">
              <i class="fa-solid fa-location-dot"></i>
              <?php echo wp_kses_post(get_field('endereco_1')); ?>
            </a>
            <a class="" target="_blank" href="<?php echo esc_url(get_field('link_endereco_2')); ?>" translate="no">
              <i class="fa-solid fa-location-dot"></i>
