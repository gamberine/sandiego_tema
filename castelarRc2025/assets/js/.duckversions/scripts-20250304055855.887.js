...
jQuery(document).ready(function () {
  ...
  jQuery(document).on('click', '.boxServicos .gridImgItems img', function (e) {
    e.preventDefault();
    // Obtém o ID do post a partir do atributo 'id' do contêiner .boxServicos
    var postId = jQuery(this).closest('.boxServicos').attr('id');
    // Constrói o ID do modal com o mesmo padrão usado no PHP
    var modalId = 'post-modal-' + postId;
    // Obtém o elemento do modal e instancia o modal do Bootstrap
