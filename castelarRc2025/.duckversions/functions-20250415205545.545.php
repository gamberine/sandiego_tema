...
function adicionar_links_dinamicos_menu()
{
  ...
  // inicio seletor de item - Galeria
  // $post_id_2 = 3042;
  ...
  //     3                       // Posição no menu
  // );
  // FIM seletor de item - Galeria

  // inicio seletor de item - DIFERENCIAL
  // $post_id_2 = 3262;
  // $edit_link_2 = admin_url("post.php?post=$post_id_2&action=edit");

  // add_menu_page(
  //   'Edição Diferenciais',    // Título da página
  //   'Diferenciais',              // Nome no menu
  //   'edit_posts',           // Capacidade necessária
  //   $edit_link_2,           // Link direto para a edição do post
  //   '',                     // Função vazia, pois redirecionaremos para o link
  //   'dashicons-star-filled', // Ícone do menu
  //   4                       // Posição no menu
  // );
  // FIM seletor de item - DIFERENCIAL

  // inicio seletor de item - Atuação
  // $post_id_2 = 3262;
  // $edit_link_2 = admin_url("post.php?post=$post_id_2&action=edit");

  // add_menu_page(
  //     'Edição Atuação',    // Título da página
  //     'Atuação    ',              // Nome no menu
  //     'edit_posts',           // Capacidade necessária
  //     $edit_link_2,           // Link direto para a edição do post
  //     '',                     // Função vazia, pois redirecionaremos para o link
  //     'dashicons-share-alt', // Ícone do menu
  //     5                      // Posição no menu
  // );
  // FIM seletor de item - Atuação
}
...
// Adiciona campo de thumbnail às categorias do post type
