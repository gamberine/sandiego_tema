...
jQuery(document).ready(function () {
  // Delegação de eventos: captura cliques na imagem dentro do boxServicos
  jQuery(document).on('click', '.boxServicos .gridImgItems img', function (e) {
    e.preventDefault();
    // Remove o foco do elemento acionador para evitar que fique retido
    jQuery(this).blur();

    // Obtém o ID do post a partir do contêiner .boxServicos
    var postId = jQuery(this).closest('.boxServicos').attr('id');
    // Constrói o ID do modal conforme o padrão definido em PHP
    var modalId = 'post-modal-' + postId;
    var modalElement = document.getElementById(modalId);

    if (modalElement) {
      var modal = new bootstrap.Modal(modalElement);

      // Quando o modal for exibido, transfere o foco para o botão de fechar
