...
//     infinite: true,
//     rtl: true,
//     initialSlide: 0,         // Sempre inicia no slide 1 (índice 0)
//     responsive: [
//       {
//         breakpoint: 991, // Configurações para telas menores
//         settings: {
...
// Evento de fechamento do modal - atrelado uma única vez fora do listener de clique
jQuery('#dynamicGalleryModal').on('hidden.bs.modal', function () {
  var sliderContainer = jQuery(this).find('.carouselSlideImgModal');
