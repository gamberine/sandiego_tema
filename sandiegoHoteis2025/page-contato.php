    ...
    <?php while (have_posts()) : the_post(); ?>
        <section class="gridCinza pb-0">
            <div class="rowFullWidth">
                <h1 class="title-primary text-center corPrincipal"><?php echo wp_kses_post(get_field('titulo_page_contatos')); ?></h1>
        ...
        <section class="gridCinza text-center py-0 my-0">
            <div class="row my-0 w-100">
                ...
                <div class="boxImgContatos col-xxl-6 col-xl-6 d-xl-block d-lg-none" style="background: url(<?php echo wp_kses_post(get_field('imagem_page_contatos')); ?>), rgba(var(--primary-color), 0.5);); background-size: cover; background-blend-mode: multiply;">
                </div>
                <div class="boxFormulario col-xxl-5 col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12">

                    <h2 class="title-primary primary mb-3"><?php echo wp_kses_post(get_field('titulo_formulario')); ?></h2>
        ...
        <section class="gridBranco text-center">
            ...
            <div class="row">
                ...
                <h2 class="title-primary primary mb-5"><?php echo wp_kses_post(get_field('titulo_page_contatos_equipe')); ?></h2>
