    ...
    <section class="gridCinza equipe" id="equipe">
      ...
      <?php wp_reset_query(); ?>
        ...
        <div class="gridEquipe row justify-content-center align-items-strech gy-4">
          ...
          <?php if (have_posts()) : ?>
            <?php while (have_posts()) : the_post(); ?>
              <div class="col-xl-5 col-lg-12 text-center corSecundariaHoverHover">
                <h3 class="fontTitulos fw-bold text-uppercase m-lg-3 m-md-auto"><?php the_title(); ?></h3>
                <div class="rowEquipeItem d-flex align-items-center justify-content-center corSecundariaHoverHover">
                  <h1 class="idItem">
