    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <section class="gridCinza equipe" id="equipe">
            ...
            <div class="container text-center corSecundaria">
                ...
                <div class="row mb-0">
                    <div class="headerSection corTexto px-5">
            ...
            <?php wp_reset_query(); ?>
                ...
                <div class="gridEquipe row justify-content-center align-items-strech gy-4">
                    ...
                    <?php if (have_posts()) : ?>
                        <?php while (have_posts()) : the_post(); ?>
                            <div class="col-xl-5 col-lg-12 text-center corSecundariaHover">
                                <h3 class="fontTitulos fw-bold text-uppercase m-3"><?php the_title(); ?></h3>
                                <div class="d-flex align-items-center justify-content-center flex-lg-column flex-md-column corSecundariaHover">
                                    <h1 class="idItem position-lg-relative me-lg-3 me-md-3">
