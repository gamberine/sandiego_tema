  ...
  <?php if (have_posts()) : ?>
    <?php while (have_posts()) : the_post(); ?>
      ...
      <section class="gridBranco" id="sobre">
        <div class="container">
          <div class="row d-flex justify-content-center align-items-flex-start gap-2">
            ...
            <div class="text-xl-start text-lg-center corTextos col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
