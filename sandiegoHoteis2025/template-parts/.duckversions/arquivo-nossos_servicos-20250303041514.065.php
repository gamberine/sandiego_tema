...
<section class="gridCinza" id="servicos">
  ...
  <div class="container text-center corPrincipalHover">
    <div class="row d-flex flex-row justify-content-center align-items-center text-center mb-0">

      <?php query_posts("post_type=conteudo&posts_per_page=1"); ?>
      <?php if (have_posts()) : ?>
        <?php while (have_posts()) : the_post(); ?>
          <div class="headerSection justify-content-center col-12 mb-0">
