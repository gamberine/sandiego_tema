      ...
      ?>
        ...
        <div class="contatoFooter text-center text-white">
          ...
          <div class="gridContatosFooter">
            ...
            <!-- ------------ -->
            <a class="d-flex align-items-center" target="_blank" href="<?php echo wp_kses_post(get_field('linkWhatsapp_pt')); ?>">
              <i class="fab fa-whatsapp"></i>
              <?php echo wp_kses_post(get_field('numeroWhatsapp_pt')); ?>
            </a>
            <a class="d-flex align-items-center" target="_blank" href="<?php echo wp_kses_post(get_field('linkWhatsapp_en')); ?>">
              <i class="fab fa-whatsapp"></i>
              <?php echo wp_kses_post(get_field('numeroWhatsapp_en')); ?>
            </a>
            <a class="d-flex align-items-center" target="_blank" href="<?php echo wp_kses_post(get_field('linkWhatsapp-ca')); ?>">
              <i class="fab fa-whatsapp"></i>
              <?php echo wp_kses_post(get_field('numeroWhatsapp_ca')); ?>
            </a>
            <!-- ------------ -->
