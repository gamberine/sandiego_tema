...
<section class="gridPrincipalTransp" id="projetos">
  <div class="container text-center text-white">
    <div class="row d-flex justify-content-center align-items-center text-center mb-3">
      ...
      <!-- ---------- loop clientes -->
      <div class="projetos sliderImgTexto">
        <?php $args = array(
          'post_type' => 'projetos',
          'posts_per_page' => -1,
          'order' => 'date',
        ...
        <?php if (have_posts()) : ?>
          ...
          ?>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 text-center text-white">
