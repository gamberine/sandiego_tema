...
<section class="gridSecundario" id="contatos">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xxl-5 col-xl-8 col-lg-10 col-md-12 col-sm-12 col-12 d-flex justify-content-center mx-auto flex-column">
        <?php query_posts("post_type=conteudo&posts_per_page=1"); ?>
        <?php if (have_posts()) : ?>
          <?php while (have_posts()) : the_post(); ?>
