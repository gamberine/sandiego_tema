...
function forcar_idioma_ingles_se_dominio_com()
{
  ...
  // Adiciona debugger no console
  echo '<script>
        console.log("Host detectado pelo PHP: ' . esc_js($dominio_origem) . '");

        if (location.hostname.includes("castelarrc.com") && !location.hostname.includes(".br")) {
            console.log("Redirecionamento detectado via .com — aplicando lang=en");

            document.documentElement.lang = "en";

            document.addEventListener("DOMContentLoaded", function () {
                // Remove classes lang- existentes
                ...
                console.log("Classe lang-en aplicada ao body");
            });
        } else {
            console.log("Domínio não é .com puro, nenhuma alteração feita.");
        }
    </script>';
}
