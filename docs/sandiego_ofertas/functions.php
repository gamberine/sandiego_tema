<?php
/**
 * FunÃ§Ãµes do tema Gepeto SD - 03-43
 */
if ( ! defined( 'ABSPATH' ) ) {
  exit;
}
...
add_action('after_setup_theme', function () {
  ...
  register_nav_menus([
    ...
    'footer'    => __('Menu RodapÃ©', 'temabasegamb'),
  ]);
...
// Garantir que as funÃ§Ãµes base estejam carregadas
...
wp_enqueue_style('sd-flaticon-uicons', 'https://cdn-uicons.flaticon.com/uicons-regular-rounded/css/uicons-regular-rounded.css', [], null);


  // JS personalizado
  wp_enqueue_script( 'sd-theme-js', get_stylesheet_directory_uri() . '/assets/js/sandiego.js', ['jquery','sd-theme-js'], '1.0.0', true );
});
...
register_post_type('conteudo', [
  'labels' => [
    'name'               => 'ConteÃºdo',
    'singular_name'      => 'ConteÃºdo',
    'add_new_item'       => 'Adicionar novo ConteÃºdo',
    'edit_item'          => 'Editar ConteÃºdo',
    'new_item'           => 'Novo ConteÃºdo',
    'view_item'          => 'Ver ConteÃºdo',
    'search_items'       => 'Buscar ConteÃºdo',
    'not_found'          => 'Nenhum ConteÃºdo encontrado',
    'not_found_in_trash' => 'Nenhum ConteÃºdo encontrado na lixeira',
  ],
  'public'       => true,
  'show_in_rest' => true,
  'has_archive'  => false,
  'show_in_menu' => false, // Mostrar no menu
  'show_in_nav_menus' => false, // NÃ£o mostrar em menus de navegaÃ§Ã£o
...
register_post_type('banner', [
  ...
  // Post type AcomodaÃ§Ã£o
  register_post_type('acomodacao', [
    'labels' => [
      'name'          => 'AcomodaÃ§Ãµes',
      'singular_name' => 'AcomodaÃ§Ã£o'
    ],
    'public'       => true,
  ...
  // Taxonomia Comodidades para HotÃ©is
...
/**
 * Shortcode: [sd_copy text="..."] â€“ BotÃ£o de cÃ³pia
 */
...
/**
 * FunÃ§Ã£o auxiliar para obter campos ACF com valor padrÃ£o
 *
 * @param string $key     O nome do campo ACF
 * @param int|null $post_id O ID do post (null = global)
 * @param mixed $default  Valor padrÃ£o se o campo estiver vazio
 * @return mixed
 */
...
/* --------------------------------------------------------------------------
 * 8) PapÃ©is / PermissÃµes / Admin UI
 * -------------------------------------------------------------------------- */

/* Renomeia rÃ³tulo de Administrator exibido */
...
/* Cria funÃ§Ã£o Administrador Site */
...
/* Ocultar itens/avisos para nÃ£o-super-admin */
function wgm_desativa_comentarios_admin_menu() {
  if ( ! current_user_can('add_users') ) {
    ...
    add_action('admin_head', function(){
      ...
      unset($menu[25]); // ComentÃ¡rios
      unset($menu[60]); // AparÃªncia
      if ( isset($submenu['index.php'][10]) ) unset($submenu['index.php'][10]); // Painel -> AtualizaÃ§Ã£o
      if ( $user_ID != 99 ) {
...
function bl_admin_footer(){
  echo 'Desenvolvido por <a href="https://gamberine.com.br" target="_blank" rel="noopener">Gamberine ComunicaÃ§Ã£o Digital</a>';
}
...
function sd_render_maintenance_settings_page() {
  ...
  ?>
  <div class="wrap">
    <h1><?php esc_html_e('PÃ¡gina em manutenÃ§Ã£o','temabasegamb'); ?></h1>
          ...
          <tr>
            ...
            <td>
              <label for="sd-maintenance-mode-enabled">
                ...
                <?php esc_html_e('Ativar pÃ¡gina em manutenÃ§Ã£o','temabasegamb'); ?>
              </label>
              <p class="description"><?php esc_html_e('Quando ativo, visitantes verÃ£o a pÃ¡gina em manutenÃ§Ã£o atÃ© que o modo seja desativado. Administradores continuam vendo o site normalmente.','temabasegamb'); ?></p>
            </td>
          </tr>
        </tbody>
      </table>
...
add_action('admin_menu', function () {
  add_submenu_page(
    'themes.php',
    __('PÃ¡gina em manutenÃ§Ã£o','temabasegamb'),
    __('PÃ¡gina em manutenÃ§Ã£o','temabasegamb'),
    'manage_options',
    'sd-maintenance-mode',
...
add_action('admin_notices', function () {
  ...
  echo '<div class="notice notice-warning"><p>'. esc_html__('O modo de manutenÃ§Ã£o estÃ¡ ativo. Visitantes estÃ£o vendo a pÃ¡gina em manutenÃ§Ã£o.','temabasegamb') .'</p></div>';
});

add_action('template_redirect', function () {
  if (!sd_is_maintenance_mode_enabled() || is_admin() || wp_doing_ajax()) {
    return;
  }
