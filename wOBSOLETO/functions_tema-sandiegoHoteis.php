...
function gamberine_login_edit()
{
  ...
  echo ') 50% 50% no-repeat !important;   
      ...
      .login h1 {
		...
		form.admin-email-confirm-form h1 {
...
//         $default_image_url = "https://localhost/flaviane/wp-content/uploads/banner-teste-1568x964.jpg";
...
{
  echo '<script>
        // Se o hostname não contiver ".br", assumimos que é o domínio .com
        if (location.hostname.indexOf(".br") === -1) {
            // Altera o atributo lang da tag <html>
            document.documentElement.lang = "en";
            
            // Aguarda o carregamento do DOM para alterar as classes do body
            document.addEventListener("DOMContentLoaded", function () {
                // Remove classes que começam com "lang-"
                document.body.classList.forEach(function(cls) {
                    if (cls.indexOf("lang-") === 0) {
                        document.body.classList.remove(cls);
                    }
                });
                // Adiciona a classe "lang-en"
