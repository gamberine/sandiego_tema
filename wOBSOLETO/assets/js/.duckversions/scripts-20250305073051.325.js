...
document.addEventListener('click', function (event) {
  ...
  // Ajusta a posição e largura do slider (garante que o slide inicial tenha a largura correta)
  ...
  // Quando o modal for fechado, "unslick" o slider para permitir futuras reaberturas
