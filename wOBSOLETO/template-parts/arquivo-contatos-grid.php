  ...
  <?php if (have_posts()) : ?>
    <?php while (have_posts()) : the_post(); ?>
      ...
      <div class="w-100 d-flex flex-wrap flex-row mx-auto overflow-hidden">
        <div class="boxImgContatos col-xxl-6 col-xl-6 col-lg-12 col-md-12" style="background: url(<?php echo wp_kses_post(get_field('background_endereco_1')); ?>); background-size: cover !important;">
        ...
        <div class="boxImgContatos col-xxl-6 col-xl-6 col-lg-12 col-md-12" style="background: url(<?php echo wp_kses_post(get_field('background_endereco_2')); ?>); background-size: cover !important;">
