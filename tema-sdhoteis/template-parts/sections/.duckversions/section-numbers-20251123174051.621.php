...
<section id="numeros" class="numbers py-5">
  <div class="container my-5">
    ...
    <?php endif; ?>
    <div class="row mt-5 gap-4 flex-wrap flex-xl-nowrap gap-3 justify-content-center align-items-center d-flexaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa">
