...
<section class="sandiego searchbar container">
  <form class="row my-2">
    <div class="gridItens col-6 col-xl-3">
   ...
   <div class="gridItens col-6 col-xl-3">
    ...
    <div class="d-flex align-items-center h-100 my-2 col-6 col-xl-1">
      <?php $url = apply_filters('sandiego/search_button_url', '#'); ?>
      <a class="btn btn-search w-100 d-flex justify-content-center align-items-center" href="<?php echo esc_url($url); ?>">
