        ...
        <div class="col-12 col-md-12 col-lg-6 col-xl-5">
          <div class="founder-card h-100 text-center p-3">
            <?php if (! empty($photo['url'])) : ?>
              <?php if ($name) : ?>
                <h4 class="mb-2 primary-color font-title"><?php echo esc_html($name); ?></h4>
              <?php endif; ?>
            ...
            <?php if ($role) : ?>
              <p class="small text-color bg-gray-light mb-2"><?php echo esc_html($role); ?></p>
            <?php endif; ?>

            <?php if ($bio) : ?>
              <p class="mb-0 sub text-color-light"><?php echo esc_html($bio); ?></p>
            <?php endif; ?>
          </div>
        </div>
      <?php endwhile; ?>
    ...
    <div class="row flex-xl-nowrap align-items-center gap-4">
      <?php if (! empty($content_block)) : ?>
        <div class="col-12 col-md-12 col-lg-12 col-xl-8">
          <div class="founder-content title-xl">
