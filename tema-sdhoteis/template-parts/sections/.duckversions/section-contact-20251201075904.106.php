...
<section class="diff container pt-0 pb-5">
  ...
  <div class="row align-items-stretch flex-lg-wrap flex-xl-nowrap gap-5 my-5">
    ...
    <!-- formulario de contato -->
     <?php echo do_shortcode('[contact-form-7 id="7772880" title="Formulario_de_contato" html_class="col-12 col-lg-12 col-xl-7 my-5 my-lg-0"]'); ?>


<!-- <div class="col-12 col-lg-12 col-xl-7 my-5 my-lg-0">
