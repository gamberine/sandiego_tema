...
// ======================================================
// 1. CARREGAR hotéis de arquivo local (SEM CORS)
// ======================================================

window.hotelsLive = [];

fetch("hotel_folders.json")
  .then(r => r.json())
  .then(data => {
    window.hotelsLive = data.sort((a, b) => {
...
// ======================================================
// 2. AUTOCOMPLETE (SEU HTML, SEU LAYOUT, MESMO ID)
// ======================================================
...
// ======================================================
// 3. FOCAR CAMPOS DE DATE (seu layout intacto)
// ======================================================
