        ...
        <?php if ( $use_image && $imagem_banner ) : ?>
          ...
          <div class="slide-items video"
                ...
                <?php endif; ?>
                    ...
                    <?php
                      // Define o alinhamento do conteúdo do banner via ACF (center, start, end).
                    ...
                    <div class="d-flex flex-column gap-3 justify-content-center <?php echo esc_attr( $align_items_class ); ?>">
