...
<script>
// ====== AUTOCOMPLETE CORRIGIDO (UNIDADES OMNIBEES) ======

const hotelsRaw = <?php echo json_encode($hotel_folders ?? []); ?>;

// Ordena por PropertySequence igual ao Omnibees
const hotels = hotelsRaw.sort((a, b) => {
