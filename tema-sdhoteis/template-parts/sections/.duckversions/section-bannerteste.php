...
<div class="rowBannerHome" id="home">
  <div class="bannerPrincipal">
    ...
    while ($banner_query->have_posts()) :
        ...
        $desktop_background = ! empty($desktop_image) ? sprintf("var(--transparent), url('%s')", esc_url_raw($desktop_image)) : 'var(--transparent)';
        $mobile_background  = ! empty($mobile_fallback) ? sprintf("var(--transparent), url('%s')", esc_url_raw($mobile_fallback)) : $desktop_background;
