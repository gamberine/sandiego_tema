...
<section class="sandiego searchbar container">
  <form id="<?php echo esc_attr($sd_form_id); ?>" class="row my-2" onsubmit="return false;">
    ...
    <!-- DESTINO / HOTEL -->
    <div class="gridItens col-12 col-md-3 position-relative">
      <label class="form-label">Destino ou Hotel</label>

      <input id="hotelInput" type="text" class="form-control" placeholder="Todos os Hotéis" autocomplete="off">
      <input type="hidden" id="hotelCode" value="0">

      <div id="hotelDropdown" class="list-group" style="display:none; position:absolute; top:100%; left:0; right:0; z-index:20; max-height:260px; overflow-y:auto;">
      </div>
    </div>
    ...
    <div class="gridItens border-none px-0 col-4 col-md-1 d-flex align-items-center">
