...
<section id="numeros" class="numbers py-5">
  <div class="container my-5">
    ...
    <?php if (! empty($section_title)) : ?>
      <h2 class="title-xl text-center text-white mb-5 pb-5"><?php echo esc_html($section_title); ?></h2>
    <?php endif; ?>
    <div class="row mt-5 gap-4 flex-wrap flex-xl-nowrap gap-3 justify-content-center align-items-center d-flex">
          ...
          <div class="col-12 col-lg-6 col-xl-3">
            <div class="item h-100 text-center">
              <div class="icon mx-auto">
                <img src="<?php echo esc_url($icon_url); ?>" alt="<?php echo esc_attr($icon_alt ?: $label_value); ?>" >
              </div>
