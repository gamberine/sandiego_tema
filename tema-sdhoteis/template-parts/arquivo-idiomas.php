...
<div class="gridIdiomas d-flex align-items-center">
  <span class="linkIdiomas d-flex"><?php echo do_shortcode('[gtranslate]'); ?></span>

<a class="btn btn-search d-flex justify-content-center align-items-center" 
   href="#sdModalReserva" role="button" aria-haspopup="dialog" aria-controls="sdModalReserva"
   data-sd-modal-target="#sdModalReserva">
