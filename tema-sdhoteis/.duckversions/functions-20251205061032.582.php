...
//   return get_stylesheet_directory() . '/a cf-json';
// });
// add_filter('acf/settings/load_json', function ($paths) {
//   unset($paths[0]);
//   $paths[] = get_stylesheet_directory() . '/a cf-json';
//   return $paths;
// });
...
add_filter('acf/settings/save_json', function($path) {
    return get_stylesheet_directory() . '/acf-json-bkp';
});
...
// ===============================================
// Máscara de Número (hotel_numero) — apenas dígitos
// ===============================================
document.addEventListener("input", function (e) {
...
document.addEventListener("blur", function (e) {
  ...
  fetch("https://viacep.com.br/ws/" + cep + "/json/")
    ...
    .then(d => {
      ...
      // hotel_numero e hotel_complemento continuam editáveis
    });
});
</script>
<?php
...
// ===============================================
// Select com estados (hotel_estado)
// ===============================================
add_filter('acf/load_field/name=hotel_estado', function($field) {
    $field['choices'] = [
