...
document.addEventListener('click', function (event) {
  ...
  items.forEach(function (item, index) {
    ...
    carouselInnerHtml += '<img src="' + item.href + '" class="d-flex imgGaleriaModal" alt="">';
  ...
  /**
   * Initializes a new Bootstrap carousel instance.
   *
   * @type {bootstrap.Carousel}
   * @param {HTMLElement} carouselElement - The DOM element that will be turned into a carousel.
   * @param {Object} options - Configuration options for the carousel.
   * @param {boolean} options.interval - Determines whether the carousel should cycle automatically.
   */
