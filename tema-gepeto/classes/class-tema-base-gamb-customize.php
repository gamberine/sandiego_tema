...
if ( ! class_exists( 'Tema_Dev_Gamb_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Tema Dev-Gamb 1.0
	 */
	class Tema_Dev_Gamb_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'temabasegamb' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'temabasegamb' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'temabasegamb' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'temabasegamb' ),
						'full'    => esc_html__( 'Full text', 'temabasegamb' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-tema-base-gamb-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Tema_Dev_Gamb_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Tema_Dev_Gamb_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'temabasegamb' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
