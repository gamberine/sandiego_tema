...
<footer id="contato" class="site-footer" role="contentinfo">
    <div class="container my-4 footer-grid text-white g-4 d-flex align-items-center">
        ...
        <!-- Brand / Logo -->
        <div class="col-12 col-lg-4 d-flex footer-brand">
        ...
        <div class="col-12 col-lg-8 d-flex flex-wrap footer-sections row-gap-3">
            ...
            <!-- Social -->
            <div class="gridRedesFooter col-12 col-md-3 footer-section footer-social">
                <p class="footer-section-title">
