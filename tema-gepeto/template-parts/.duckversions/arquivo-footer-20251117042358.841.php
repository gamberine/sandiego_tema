  ...
  <div class="container my-0">
    <div class="footer-grid text-white row g-4 align-items-center mt-0">
      ...
      <div class="col-12 col-lg-8 mt-0">
        <div class="my-0 row d-flex footer-sections row-gap-3">
          ...
          <!-- Social -->
          <div class="gridRedesFooter col-12 col-md-3">
            <div class="footer-section footer-social bg-primary-color">
              <p class="footer-section-title">
          ...
          <?php if ( ! empty( $company_info_lines ) && is_array( $company_info_lines ) ) : ?>
            <div class="col-12 pt-0">
              <div class="mt-0 footer-extra-info">
                <?php
