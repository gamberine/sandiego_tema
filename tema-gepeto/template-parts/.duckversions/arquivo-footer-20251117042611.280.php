...
<footer id="contato" class="site-footer container my-0">
    <div class="footer-grid text-white row g-4 align-items-center mt-0">
      ...
      <div class="col-12 col-lg-8 mt-0 d-flex footer-sections row-gap-3">
