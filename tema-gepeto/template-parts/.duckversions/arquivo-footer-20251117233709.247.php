...
<footer id="contato" class="site-footer" role="contentinfo">
    <div class="container my-4 footer-grid text-white g-4 d-flex align-items-center">
        ...
        <!-- Brand / Logo -->
        <div class="col-12 col-lg-3 d-flex footer-brand">
            <?php if ( ! empty( $logo_url ) ) : ?>
            <a class="footer-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                <img class="w-auto" src="<?php echo esc_url( $logo_url ); ?>"
        ...
        <div class="col-12 col-lg-9 d-flex justify-content-space-between flex-wrap footer-sections row-gap-4">

            <!-- Nossa Empresa / Menu -->
            <div class="col-12 col-md-4 footer-section footer-navigation">
            ...
            <!-- Contato -->
            <div class="col-12 col-md-5 footer-section footer-contact">
                <p class="footer-section-title">
                ...
                <ul class="footer-contact-list">
                    ...
                    <li class="footer-contact-line gap-3">
                        ...
                        <a class="footer-item-content" href="<?php echo esc_url( $link_url ); ?>"
            ...
            <!-- Social -->
            <div class="gridRedesFooter col-12 col-md-2 footer-section footer-social">
                <p class="footer-section-title">
                ...
                <div class="footer-social-links">
                      ...
                      ?>
                    <a class="footer-social-link" href="<?php echo esc_url( $social_url ); ?>"
                        <?php echo $social_target ? ' target="' . esc_attr( $social_target ) . '"' : ''; ?>
                        <?php echo $social_rel ? ' rel="' . esc_attr( $social_rel ) . '"' : ''; ?>
            ...
            <!-- Informações institucionais / extra -->
            <?php if ( ! empty( $company_info_lines ) && is_array( $company_info_lines ) ) : ?>
            <div class="col-12 pt-0 mt-0 footer-extra-info">
                <?php
                    foreach ( $company_info_lines as $info_line ) :
