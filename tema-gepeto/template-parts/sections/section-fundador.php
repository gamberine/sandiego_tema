...
<section class="founders container py-5">
  <div class="text-center mb-5">
    ...
    <?php if ($section_label) : ?>
      <span class="badge px-4 py-2 text-bg-success fw-semibold"><?php echo esc_html($section_label); ?></span>
    <?php endif; ?>
  </div>
          ...
          <div class="founder-card h-100 text-center p-3">
            <?php if (! empty($photo['url'])) : ?>
              <div class="mb-3 founder-photo">
                <img src="<?php echo esc_url($photo['url']); ?>" alt="<?php echo esc_attr($photo['alt'] ?? $name); ?>" class="img-fluid rounded shadow-sm">
              </div>
            <?php endif; ?>

            <?php if ($name) : ?>
              <h3 class="h5 text-primary mb-1"><?php echo esc_html($name); ?></h3>
            <?php endif; ?>
    ...
    <div class="row g-4 align-items-center">
      <?php if (! empty($content_block)) : ?>
        <div class="col-12 col-lg-6">
          <div class="pe-lg-4 founder-content">
      ...
      <?php if (! empty($highlight_image['url'])) : ?>
        <div class="col-12 col-lg-6">
          <div class="text-center founder-highlight-image">
            <img src="<?php echo esc_url($highlight_image['url']); ?>" alt="<?php echo esc_attr($highlight_image['alt'] ?? ''); ?>" class="img-fluid rounded shadow-sm">
          </div>
        </div>
      <?php endif; ?>
    </div>
