...
function temabasegamb_customize_preview_init() {
  ...
  wp_enqueue_script(
    ...
    ['customize-preview', 'customize-selective-refresh', 'jquery', 'temabasegamb-customize-helpers'],
    wp_get_theme()->get('Version'),
    true
  );
}
...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_enqueue_style(
    'sd-font-diavlo',
    'https://use.typekit.net/nez2mlc.css',
    [],
    null
  );
  ...
  wp_enqueue_style(
    'sd-font-fira',
    'https://fonts.googleapis.com/css2?family=Fira+Sans:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;1,400&display=swap',
    [],
    null
  );
  ...
  wp_enqueue_style(
    'sd-variaveis',
    get_stylesheet_directory_uri() . '/assets/css/style-variaveis.css',
    [],
    '1.0.0'
  );
  ...
  wp_enqueue_style(
    'sd-style-base',
    get_stylesheet_directory_uri() . '/assets/css/style-base.css',
    [],
    '1.0.0'
  );

  // JS personalizado FRONT
  wp_enqueue_script(
    'scripts-js',
...
function wgm_admin_assets( $hook ) {
  ...
  wp_enqueue_script(
    'sd-scripts-admin',
    get_template_directory_uri() . '/assets/js/scripts-admin.js',
    ['jquery'],
    '1.0.0',
    true
  );
